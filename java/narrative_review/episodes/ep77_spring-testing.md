...
1. In the last episode, we worked through Spring Security.
2. If that made sense, today builds on it. If it was fuzzy, today usually makes it click.
3. Tests should be fast where possible — slices before full context.
...
2. Picture Spring Testing clearly.
3. Here are the points that matter when code meets production:
4. Point 1: Unit tests without Spring.
5. If you remember only one thing, make it that.
6. Point 2: @WebMvcTest/@DataJpaTest slices.
7. This is usually where tutorials stop — we will not.
8. Point 3: @SpringBootTest when needed.
9. Point 4: Testcontainers for realism.
10. Point 5: Deterministic data.
...
3. With Spring Testing, mastery is not more jargon.
...
2. Question: When @SpringBootTest?
3. Answer: When you truly need the full context; prefer slices for speed.
...
6. @WebMvcTest/@DataJpaTest slices.
...
3. 1) Say out loud what Spring Testing is for in one sentence.
...
2. Episode 78: Microservices Basics.
