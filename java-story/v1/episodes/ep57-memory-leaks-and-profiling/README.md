...
![Episode 57 thumbnail](thumbnail.jpg)
...
| Video (clean) | [`Java_Episode_57_Memory_Leaks_Profiling.mp4`](Java_Episode_57_Memory_Leaks_Profiling.mp4) |
| Video (captioned) | [`Java_Episode_57_Memory_Leaks_Profiling_CAPTIONED.mp4`](Java_Episode_57_Memory_Leaks_Profiling_CAPTIONED.mp4) |
| Captions (SRT) | [`Java_Episode_57.srt`](Java_Episode_57.srt) |
...
- Previous: [ep56-gc-collectors](../ep56-gc-collectors/)
- Next: [ep58-diagnostic-tools](../ep58-diagnostic-tools/)
