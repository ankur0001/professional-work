...
Usage:
  ...
  python3 java-story/v2/video_build/render_v2_from_narrative.py --ep 1-5 --reuse-audio
  python3 java-story/v2/video_build/render_v2_from_narrative.py --all
"""
...
def render_one(path: Path, reuse_audio: bool = False, max_beats: int | None = None) -> dict:
    ...
    src.write_text(
        ...
        f"Narration: `java-story/v2/narrative_review/episodes/{path.name}`\n"
        f"Renderer: `java-story/v2/video_build/render_v2_from_narrative.py`\n"
        f"Visuals: animated scenes via `java-story/v2/video_build/visual_engine.py`\n"
