...
![Episode 04 thumbnail](thumbnail.jpg)
...
| Video (clean) | [`Java_Episode_04_Variables_and_Data_Types.mp4`](Java_Episode_04_Variables_and_Data_Types.mp4) |
| Video (captioned) | [`Java_Episode_04_Variables_and_Data_Types_CAPTIONED.mp4`](Java_Episode_04_Variables_and_Data_Types_CAPTIONED.mp4) |
| Captions (SRT) | [`Java_Episode_04.srt`](Java_Episode_04.srt) |
| Narration / transcript | [`narration.md`](narration.md) |
| Build provenance | [`Java_Episode_04_SOURCE.md`](Java_Episode_04_SOURCE.md) |
...
- Previous: [ep03-java-program-structure](../ep03-java-program-structure/)
- Next: [ep05-operators](../ep05-operators/)
