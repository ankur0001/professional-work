...
![Episode 66 thumbnail](thumbnail.jpg)
...
| Video (clean) | [`Java_Episode_66_JVM_Interview_Wrap.mp4`](Java_Episode_66_JVM_Interview_Wrap.mp4) |
| Video (captioned) | [`Java_Episode_66_JVM_Interview_Wrap_CAPTIONED.mp4`](Java_Episode_66_JVM_Interview_Wrap_CAPTIONED.mp4) |
| Captions (SRT) | [`Java_Episode_66.srt`](Java_Episode_66.srt) |
| Narration / transcript | [`narration.md`](narration.md) |
| Build provenance | [`Java_Episode_66_SOURCE.md`](Java_Episode_66_SOURCE.md) |
...
- Previous: [ep65-jvm-startup](../ep65-jvm-startup/)
- Next: [ep67-design-patterns-intro](../ep67-design-patterns-intro/)
