...
![Episode 56 thumbnail](thumbnail.jpg)
...
| Video (clean) | [`Java_Episode_56_GC_Collectors.mp4`](Java_Episode_56_GC_Collectors.mp4) |
| Video (captioned) | [`Java_Episode_56_GC_Collectors_CAPTIONED.mp4`](Java_Episode_56_GC_Collectors_CAPTIONED.mp4) |
| Captions (SRT) | [`Java_Episode_56.srt`](Java_Episode_56.srt) |
| Narration / transcript | [`narration.md`](narration.md) |
| Build provenance | [`Java_Episode_56_SOURCE.md`](Java_Episode_56_SOURCE.md) |
...
- Previous: [ep55-jit-compilation](../ep55-jit-compilation/)
- Next: [ep57-memory-leaks-and-profiling](../ep57-memory-leaks-and-profiling/)
