...
![Episode 59 thumbnail](thumbnail.jpg)
...
| Video (clean) | [`Java_Episode_59_Escape_Analysis.mp4`](Java_Episode_59_Escape_Analysis.mp4) |
| Video (captioned) | [`Java_Episode_59_Escape_Analysis_CAPTIONED.mp4`](Java_Episode_59_Escape_Analysis_CAPTIONED.mp4) |
| Captions (SRT) | [`Java_Episode_59.srt`](Java_Episode_59.srt) |
| Narration / transcript | [`narration.md`](narration.md) |
| Build provenance | [`Java_Episode_59_SOURCE.md`](Java_Episode_59_SOURCE.md) |
...
- Previous: [ep58-diagnostic-tools](../ep58-diagnostic-tools/)
- Next: [ep60-metaspace-and-native-memory](../ep60-metaspace-and-native-memory/)
