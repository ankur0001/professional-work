#!/usr/bin/env python3
"""Push java-story/output/v2 deliverables into each episode PR branch and retitle.

Expects v2 files already rendered under java-story/output/v2/.
Copies into each episode branch as java-story/output/v2/ (common folder name).

Usage:
  python3 java-story/video_build/distribute_v2_to_episode_prs.py --ep 1-5
  python3 java-story/video_build/distribute_v2_to_episode_prs.py --all
"""
...
ROOT = Path("/workspace")
V2 = ROOT / "java-story" / "output" / "v2"
NARR = ROOT / "java-story" / "narrative_review" / "episodes"
