...
| Video (clean) | [`Spring_Episode_83_Microservices_with_Spring.mp4`](Spring_Episode_83_Microservices_with_Spring.mp4) |
| Video (captioned) | [`Spring_Episode_83_Microservices_with_Spring_CAPTIONED.mp4`](Spring_Episode_83_Microservices_with_Spring_CAPTIONED.mp4) |
| Captions (SRT) | [`Spring_Episode_83.srt`](Spring_Episode_83.srt) |
...
- Next: [ep84-configuration-server](../ep84-configuration-server/)
