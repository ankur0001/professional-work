#!/usr/bin/env python3
"""Animated visual scenes for The Spring Story videos.
...
PANEL = (22, 48, 38)
PANEL2 = (28, 58, 44)
AMBER = (109, 179, 63)  # Spring leaf (kept name for fewer diffs)
TEAL = (140, 200, 90)
SKY = (120, 190, 140)
CORAL = (200, 120, 80)
CREAM = (245, 247, 240)
...
def chrome(draw: ImageDraw.ImageDraw, ep: int, title: str, idx: int, total: int, t: float) -> None:
    ...
    fr = font(FONT_REG, 24)
    draw.text((72, 40), "The Spring Story", font=fb, fill=AMBER)
