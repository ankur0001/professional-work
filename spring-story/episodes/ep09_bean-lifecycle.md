...
A bean is not only created. It is initialized, ready, used, and eventually destroyed. Spring's lifecycle hooks exist because production needs that control.
